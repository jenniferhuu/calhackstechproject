...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-neutral-100 flex flex-col items-center justify-center p-8 text-black">
      ...
      <div className="bg-white/80 backdrop-blur-sm border border-gray-200 p-8 rounded-2xl shadow-lg max-w-md w-full">
        <div className="mb-6">
          ...
          {current.options.map(function (opt) {
            ...
            return (
              <button
                ...
                className={
                  "px-4 py-3 rounded-xl border transition transform hover:scale-105 text-sm capitalize " +
                  (selected ? "bg-rose-400 text-white border-rose-400 shadow" : "bg-white hover:border-rose-300")
                }
              >
                {opt}
              </button>
